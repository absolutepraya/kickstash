"""
Django settings for kickstash project.
...
SECRET_KEY = "django-insecure-(2(8gwhi#9kb2rfq(ud^xw@9bcydwgm4eq+$w&t+7zoapq1%t$"
...
WSGI_APPLICATION = "kickstash.wsgi.application"
